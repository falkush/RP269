...
public class bin-picture {
	...
	{
		 BufferedImage frame = new BufferedImage(n,nb,BufferedImage.TYPE_INT_RGB);
		...
		for(i=0;i<nb;i++)
		{
			...
			for(j=0;j<n;j++) 
			{
				...
				{
					frame.setRGB(j, i, Color.WHITE.getRGB());
				}
			}
		...
		ImageIO.write(frame, "png", new File("C:/test/img.png/"));
